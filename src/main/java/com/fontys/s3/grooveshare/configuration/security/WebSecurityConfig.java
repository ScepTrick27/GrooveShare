package com.fontys.s3.grooveshare.configuration.security;

import com.fontys.s3.grooveshare.configuration.security.auth.AuthenticationRequestFilter;
...
//                                .requestMatchers(HttpMethod.PUT, "/posts/{id}").permitAll()
//                                .requestMatchers(HttpMethod.DELETE, "/posts/{id}").permitAll()
